...
import 'package:quickcash/Screens/StatemetScreen/statement_details_screen.dart';
...
class _StatementScreenState extends State<StatementScreen> {
  ...
  void _navigateToDetail(Map<String, String> statements) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => StatementDetailsScreen(statements: statements),
      ),
    );
  }
