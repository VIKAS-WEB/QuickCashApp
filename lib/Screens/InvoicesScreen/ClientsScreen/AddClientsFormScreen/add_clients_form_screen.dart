...
class _AddClientsFormScreenState extends State<AddClientsFormScreen> {
  ...
  Future<void> mAddClient() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      try{
        final request = AddClientRequest(userId: AuthManager.getUserId(), firstName: firstName.text, lastName: lastName.text, email: email.text, mobile: mobileNumber, postalCode: postal, country: country.text, state: state.text, city: city.text, address: address.text, notes: note.text);
